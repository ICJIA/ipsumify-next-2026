...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "ecaecb6c-ae3c-49ba-8214-a105fb50a4a4",
...
const _4RYnKYTVjpCAF6OhRtxHfqfYVDWxFHA0FO8EY4RR4U = defineNitroPlugin(async (nitroApp) => {
...
const _XfyavddBitpmgnOPkSqAF1CJ5GDEOwJAKGEjPLzLY2g = defineNitroPlugin(async (nitroApp) => {
...
const _uMLR_jSRoH9Q_cr5Thq7TAWSwXsMHhoWP2FiLDk7Nc = (function(nitro) {
...
const plugins = [
  _4RYnKYTVjpCAF6OhRtxHfqfYVDWxFHA0FO8EY4RR4U,
_XfyavddBitpmgnOPkSqAF1CJ5GDEOwJAKGEjPLzLY2g,
_uMLR_jSRoH9Q_cr5Thq7TAWSwXsMHhoWP2FiLDk7Nc
];
...
const _KhIS9q = defineCachedEventHandler(async (event) => {
...
const _OhwmT2 = eventHandler(async (e) => {
...
const _irncfR = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const __Ew2Ya = defineEventHandler(async (e) => {
...
const _ocbNnF = defineEventHandler(async (e) => {
...
const _fLSuj9 = defineEventHandler(sitemapXmlEventHandler);

const _lazy_ruxyac = () => import('../routes/api/generate.get.mjs');
const _lazy_6Ohx8r = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/api/generate', handler: _lazy_ruxyac, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_6Ohx8r, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _KhIS9q, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _OhwmT2, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _irncfR, lazy: false, middleware: false, method: undefined },
  { route: '', handler: __Ew2Ya, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _ocbNnF, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _fLSuj9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_6Ohx8r, lazy: true, middleware: false, method: undefined }
];
...
export { getResponseStatusText as a, buildAssetsURL as b, createError$1 as c, defineEventHandler as d, getResponseStatus as e, defineRenderHandler as f, getQuery as g, destr as h, getRouteRules as i, joinURL as j, useNitroApp as k, handler as l, publicAssetsURL as p, setResponseHeader as s, useRuntimeConfig as u };
